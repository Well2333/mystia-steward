...
const guidePages: GuideSection[] = [
  {
    ...
    steps: [
      ...
      '配置过滤策略：料理、酒水、食材都支持“全可用 / 仅稀客 / 禁用”三态。',
  ...
  },
  {
    ...
    steps: [
      ...
      '在“料理 / 酒水”标签间切换，分别查看料理和酒水推荐。',
      '料理排序可在“覆盖优先”和“利润优先”之间切换，按当前目标决定。',
  ...
  {
    title: '稀客页：按点单标签锁定完美',
    summary: '这里是稀客专项工具，核心目标是尽快找到“完美优先”的料理和酒水。',
    icon: Crown,
    steps: [
      '先选地区，再点击目标稀客头像，可在同地区客人之间快速切换。',
      '如果列表太长，可以隐藏未遇到的稀客，只保留已解锁对象。',
      '按点单内容分别选择“点单料理 Tag”和“点单酒水 Tag”，页面会记住你的选择。',
      '筛选默认采用“隐藏非完美”，也可以在稀客页筛选栏切换到“隐藏低于 X 分以下料理”。',
      '悬浮查看料理时，可以看到命中喜好 Tag、命中厌恶 Tag、基础原料和可追加配料。',
